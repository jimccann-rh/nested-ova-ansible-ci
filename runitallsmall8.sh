...
echo "@@@"
time ansible-playbook -i hosts main.yml --extra-var version="8" --extra-var='{"target_hosts": [nested8-singlemyjobname1-host.vpshere.local,nested8-singlemyjobname2-host.vpshere.local]}' --extra-var='{"target_vcs": [nested8-singlemyjobname-VC.vpshere.local]}' --extra-var esximemory="65536" --extra-var esxicpu="16"
